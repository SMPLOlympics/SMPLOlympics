...
class HumanoidIm(humanoid_amp_task.HumanoidAMPTask):
    ...
    def _compute_task_obs(self, env_ids=None, save_buffer = True):
        ...
        if save_buffer:
            self.save_kin_buffer(env_ids, motion_res)
        return obs
    ...
    def _hack_motion_sync(self):
        ...
        self._set_env_state(
            env_ids=env_ids,
            root_pos_list=root_pos,
            root_rot_list=root_rot,
            dof_pos_list=dof_pos,
            root_vel_list=root_vel,
            root_ang_vel_list=root_ang_vel,
            dof_vel_list=dof_vel,
            rigid_body_pos_list=rb_pos,
            rigid_body_rot_list=rb_rot,
            rigid_body_vel_list=body_vel,
            rigid_body_ang_vel_list=body_ang_vel,
        )
